...
class Society:
    ...
    def input_data(self):
        self.society_name = input("enter name and surname with a blank between them to add new member:")
        self.house_no_of_mem = int(input("enter  house number of new member: "))
        self.income = int(input("enter income of new member: "))
