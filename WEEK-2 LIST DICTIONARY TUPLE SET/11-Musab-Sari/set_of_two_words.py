...
Explanation : Set of two words is an application where user inputs two words and outputs in a list 
as follows shared letters of the words, unique letters of word one
...
shared_letters  = (''.join(sorted(list(word_1 & word_2))))
