...
label_text = tk.Label(frame, text="Password: ",font="sans 20")
label_text.grid(padx = 70, pady = 20)

label = tk.Label(frame, text ="Click the button to generate a password",font="sans 16",fg="red" )
label.grid(padx = 70, pady = 20)


button = tk.Button(frame,text="Click to Generate",font="sans20",width= 70, height=7,command=random_password)
