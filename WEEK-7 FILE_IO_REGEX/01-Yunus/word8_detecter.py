...
radical chances, putting his king into such sharp and unnecessary perils that it even provoked comment from
the white-haired old lady knitting placidly by the fire. "Hark at the wind," said Mr. White, "who, having 
...
Path's a bog, and the road's a torrent. I don't know what people are thinking about. I suppose because 
...
only two houses in the road are let, they think it doesn't matter.
'''
long_8_regex = re.compile(r'\w{8}')
long_8 = long_8_regex.findall(message)
print(long_8)