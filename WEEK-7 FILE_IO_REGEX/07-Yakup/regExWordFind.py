...
said the latter grimly surveying the board as he stretched out his hand. "Check." 
...
White with sudden and unlooked-for violence;
...
txt='''Without, the night was cold and wet, but in the small parlour of Laburnum villa 
the blinds were drawn and the fire burned brightly. Father and son were at chess; 
the former, who possessed ideas about the game involving radical chances, 
putting his king into such sharp and unnecessary perils that
it even provoked comment from the white-haired old lady knitting placidly by the fire.
...
I suppose because only two houses in the road are let, they think it doesn't matter.'''
pattern=r"\w{8}"
mo = re.findall(pattern,txt) #findall finds all the searched patterns in a text and returns to us as a list.
print()
print(mo,"\n")

for i in mo:       #To see the list elements line by line.
    print(i)
print()
